...
- (UIImage *)mdf_newBorderMask:(NSUInteger)borderSize size:(CGSize)size {
    ...
    CGContextSetFillColorWithColor(maskContext, [UIColor mdf_colourWithHexString:@"000000"].CGColor);
    CGContextFillRect(maskContext, CGRectMake(0, 0, size.width, size.height));
    
    // Make the inner part (within the border) opaque
    CGContextSetFillColorWithColor(maskContext, [UIColor mdf_colourWithHexString:@"ffffff"].CGColor);
                    ...
                    borderColor:(UIColor *)borderColor
{
    ...
    roundedRect.lineWidth = 1.0f / [UIScreen mainScreen].scale;

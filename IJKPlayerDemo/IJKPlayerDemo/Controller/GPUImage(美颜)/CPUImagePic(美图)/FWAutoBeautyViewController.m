...
- (void)viewDidLoad {
    ...
    self.imageView.frame = CGRectMake(0, 0, KScreenWidth, KScreenHeight - 115);
    ...
    self.btnClose.frame = CGRectMake(20, KScreenWidth - kCancelHeight - 10, kCancelHeight, kCancelHeight);
    ...
    self.styleBar = [[FWEffectBar alloc] initWithFrame:CGRectMake(0, KScreenHeight - 105, KScreenWidth, kBarHeight)];
    ...
    if (self.styleBar.items.count > 0) {

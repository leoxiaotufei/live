...
- (void)viewDidLoad {
    ...
    self.imageView.frame = CGRectMake(0, 0, KScreenWidth, KScreenHeight - 130);
    ...
    self.btnSave.frame = CGRectMake(KScreenWidth - kCancelHeight - 20, KScreenHeight - kCancelHeight - 10, kCancelHeight, kCancelHeight);
    ...
    FWMoreEffectView *seView = [[FWMoreEffectView alloc] initWithFrame:CGRectMake(15, KScreenHeight - 50 - kHeight, kWidth, kHeight)];
    [self.view addSubview:seView];
    
    self.borderStyleBar = [[FWEffectBar alloc] initWithFrame:CGRectMake(70, KScreenHeight - 50 - kHeight, KScreenWidth - 70, kHeight)];
